...
particleMeshsize = 40
meshsize = 200
numb = 100**2 #must be a perfect square.
LL = 10
...
### Comparison between Slicing and Regular Update Methods
...
anim = matplotlib.animation.FuncAnimation(fig,animate,frames=range(0,20,1),
