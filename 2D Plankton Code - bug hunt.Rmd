...
### A unit test of the diffusion decay operator.
...
### Test the BuildPeriodic method for extending the scalar field to include the right and upper boundaries.
...
```{python}
plt.figure()
plt.pcolormesh(field.xm,field.ym,field.scalar)
plt.colorbar()
#plt.contour(field.xm,field.ym,testFunction)
plt.show()
```
