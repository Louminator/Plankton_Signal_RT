...
Swimmers = PS.Plankton(DP.constantDep,d1=0.2,d2=5,N = meshsize,depMaxStr=.01,Const=3,L=LL,k=0.02,epsilon=1e-3,depThreshold=0.05, depTransWidth=0.03, num = numb, c0=0.012)
...
print('Relative Error in Total Chemical Between Right and Top: {0}'.format((np.sum(Top)-np.sum(Right))/np.sum(Right)))
